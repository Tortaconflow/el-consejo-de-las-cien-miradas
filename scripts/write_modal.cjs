...
// 1. App.jsx with Skip Link and Landmarked Sections
const appLines = [
...
console.log('Saved accessible App.jsx');

// 2. Oracle.jsx with share / copy verdict action & accessible labels
const oracleLines = [
...
fs.writeFileSync(path.join(rootDir, 'src', 'components', 'Oracle.jsx'), oracleLines.join('\n'), 'utf8');
console.log('Saved accessible Oracle.jsx');